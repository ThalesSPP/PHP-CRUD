...
<head>
    ...
    <title>Deleção de Clientes</title>
</head>
<body>
...
<style>
    ...
    <div class="menu2 px-4 py-5 my-5 text-center">
        <h1 class="display-5 fw-bold text-body-emphasis">Formulário para Deleção de Clientes</h1>
    </div>
            ...
            <form action="#" method="post">
                ...
                <div class="box-btn">
                    ...
                    <button type="submit" class="btn-envia zoom-shadow">
                        <i class="icon icon-forward-1"> Deletar Cliente</i>
                    </button>
                    <br>
                    <br>
                </div>
